...
export const PROGRESSION_GOALS: readonly ProgressionGoal[] = [
    ...
    { id: "meridian-purification", label: "Purification of Meridians", startExponent: 16, endExponent: 71, maximumBeforeCompletion: 0.99, completion: "meridian-purification" },
    { id: "guild", label: "the Guild", startExponent: 71, endExponent: 210, maximumBeforeCompletion: 0.99, completion: "guild-member" },
