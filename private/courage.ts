import { gt, gte, subUS, toNumber, writeDecimal, writeNumber } from "./break_eternity.js";
...
export function activateCourage(): bool {
    ...
    writeNumber(player.courageTimer, COURAGE_DURATION);
    writeNumber(player.courageCooldown, COURAGE_COOLDOWN);
    return true;
}
